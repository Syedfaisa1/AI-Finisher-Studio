...
// const articles = [
//   {
//     slug: "hidden-costs-ship-fast",
//     category: "Technical Debt",
//     date: "Feb 28, 2026",
//     readTime: "6 min",
//     title: "The Hidden Costs of \"Ship Fast\" Culture in SaaS",
//     desc: "Technical debt compounds faster than you think. Learn how rushed MVPs create maintenance nightmares that block growth.",
//     author: "Tameem",
//     image: image1
//   },
//   {
...
//     desc: "Enterprise customers demand SOC 2, GDPR, and proper auth. Here's what no-code tools leave out and why it matters.",
//     author: "Tameem",
//     image: image2
//   },
//   {
...
//     date: "Feb 22, 2026",
//     readTime: "7 min",
//     title: "Code Review Checklist: What VCs Look For in Your Codebase",
//     desc: "Due diligence kills deals. Make sure your MVP can pass technical scrutiny from investors and enterprise buyers.",
//     author: "Tameem",
//     image: image3
//   },
//   {
...
//     date: "Feb 20, 2026",
//     readTime: "9 min",
//     title: "Scaling to 10K Users: Infrastructure That Grows With You",
//     desc: "Your prototype handles 50 users fine. But when growth hits, will your backend collapse? A guide to scale-ready architecture.",
//     author: "Tameem",
//     image: image4
//   },
//   {
...
//     date: "Feb 18, 2026",
//     readTime: "5 min",
//     title: "The Real Cost of \"Move Fast and Break Things\"",
//     desc: "Speed matters. But breaking things in production costs more than taking time to build right. Here's the data.",
//     author: "Tameem",
//     image: image5
//   }
// ];
...
//           Real-world lessons from turning fragile <br /> prototypes into production-ready MVPs
//         </p>
...
//           <Link to={`/blog/${articles[0].slug}`} state={articles[0]} className="mb-16 group block cursor-pointer">
...
//               </div>
//               <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-tight group-hover:text-[#14bc8b] transition-colors">From AI Prototype to Production: The Real Engineering Gap</h2>
//               <p className="text-gray-400 text-sm mb-6 leading-relaxed">Why 87% of AI-generated MVPs never make it to production, and how to bridge the gap between "demo magic" and deployable software.</p>
...
//                     <p className="text-[10px] text-gray-600">March 18, 2026</p>
//                   </div>
//                 </div>
...
const featuredArticle = {
  ...
  date: "March 18, 2026",
  readTime: "8 min",
  title: "From AI Prototype to Production: The Real Engineering Gap",
  desc: "Why 87% of AI-generated MVPs never make it to production, and how to bridge the gap between \"demo magic\" and deployable software.",
  author: "Tameem",
  image: headerImage
};
  ...
  return (
    <div className="bg-[#0a0a0a] mt-20 min-h-screen text-white font-sans selection:bg-[#14bc8b]/30 relative overflow-hidden">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20 relative z-10">
        ...
        <div className="mb-16 group cursor-pointer">
          <Link to={`/blog/${featuredArticle.slug}`} state={featuredArticle} className="group block">
            <div className="relative overflow-hidden rounded-[20px] bg-[#111111] border border-white/5 flex flex-col md:flex-row items-center gap-6 p-2">
              <div className="w-full md:w-[45%] h-64 md:h-[350px] overflow-hidden rounded-[16px]">
                <img 
              ...
              <div className="w-full md:w-[55%] pr-6 py-4 md:py-0">
                <div className="flex items-center gap-3 mb-4">
                  <span className="flex items-center gap-1 bg-[#14bc8b]/10 text-[#14bc8b] px-2 py-1 rounded text-[9px] font-bold uppercase tracking-widest">
                    <TrendingUp size={10} /> {featuredArticle.category}
                  </span>
                  <span className="flex items-center gap-1.5 text-gray-500 text-[11px]"><Clock size={12} /> {featuredArticle.readTime}</span>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-tight group-hover:text-[#14bc8b] transition-colors">{featuredArticle.title}</h2>
                <p className="text-gray-400 text-sm mb-6 leading-relaxed">{featuredArticle.desc}</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-full bg-[#14bc8b] flex items-center justify-center text-[#050505] text-[10px] font-bold">TM</div>
                    <div>
                      <p className="text-xs font-semibold">{featuredArticle.author}</p>
                      <p className="text-[10px] text-gray-600">{featuredArticle.date}</p>
                    </div>
                  </div>
                  <span className="text-[#14bc8b] text-xs font-bold flex items-center gap-1.5 group-hover:translate-x-1 transition-transform">Read Article <ArrowRight size={14} /></span>
                </div>
              </div>
            </div>
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((post, i) => (
            <Link 
              ...
              to={`/blog/${post.slug}`} 
              state={post}
              className="group bg-[#111111] border border-white/5 rounded-[20px] p-1.5 flex flex-col hover:border-[#14bc8b]/20 transition-all cursor-pointer"
            >
              <div className="relative h-48 overflow-hidden rounded-[16px] mb-4">
                <img src={post.image} alt={post.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                <span className="absolute bottom-3 left-3 bg-[#14bc8b] text-[#050505] px-2.5 py-1 rounded text-[9px] font-bold uppercase tracking-wider">{post.category}</span>
        ...
        <div className="bg-[#111111] border border-white/5 rounded-[24px] p-10 text-center relative overflow-hidden">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input 
              ...
              className="flex-grow bg-[#050505] border border-white/10 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#14bc8b]/40 placeholder:text-gray-800"
            />
            <button className="bg-[#14bc8b] hover:bg-[#10a378] text-[#050505] font-bold px-6 py-2.5 rounded-lg text-sm transition-all cursor-pointer">
              Subscribe
            </button>
          </form>
        </div>
