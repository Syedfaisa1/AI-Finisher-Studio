...
//             Endless demos... <span className="text-[#FF6E6E]">and no real launch</span>
//           </p>
//           <button className="bg-[#14bc8b] hover:bg-[#10a378] text-[#121212] cursor-pointer px-6 py-3 rounded-md font-bold text-sm transition-all flex items-center gap-2 group shadow-[0_0_15px_rgba(20,188,139,0.2)]">
//             Get Started 
//             <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
//           </button>
//         </motion.div>
...
// 1. Destructure onOpenForm from props here
export default function TargetAudienceSection({ onOpenForm }) {
    ...
    <section ref={ref} className="bg-[#0a0a0a] py-24 px-6 overflow-hidden">
      <div className="max-w-5xl mx-auto relative">
        ...
        >
          ...
          {/* 2. Attach onOpenForm to the onClick event here */}
          <button onClick={onOpenForm} className="bg-[#14bc8b] hover:bg-[#10a378] text-[#121212] cursor-pointer px-6 py-3 rounded-md font-bold text-sm transition-all flex items-center gap-2 group shadow-[0_0_15px_rgba(20,188,139,0.2)]">
            Get Started 
            <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
          </button>
